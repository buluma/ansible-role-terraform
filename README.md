# [Ansible role terraform](#ansible-role-terraform)

Install and configure terraform on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-terraform/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-terraform/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-terraform.svg)](https://github.com/buluma/ansible-role-terraform/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-terraform.svg)](https://github.com/buluma/ansible-role-terraform/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-terraform.svg)](https://github.com/buluma/ansible-role-terraform/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/terraform)](https://galaxy.ansible.com/ui/standalone/roles/buluma/terraform/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-terraform/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-terraform/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-terraform
